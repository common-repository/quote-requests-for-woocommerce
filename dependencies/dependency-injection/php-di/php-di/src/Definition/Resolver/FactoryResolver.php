...
namespace DWS_QRWC_Deps\DI\Definition\Resolver;
...
use DWS_QRWC_Deps\DI\Invoker\FactoryParameterResolver;
use DWS_QRWC_Deps\Invoker\Exception\NotCallableException;
use DWS_QRWC_Deps\Invoker\Exception\NotEnoughParametersException;
