...
namespace DWS_QRWC_Deps\DI\Compiler;

use function chmod;
use DWS_QRWC_Deps\DI\Definition\ArrayDefinition;
use DWS_QRWC_Deps\DI\Definition\DecoratorDefinition;
...
use DWS_QRWC_Deps\DI\DependencyException;
use DWS_QRWC_Deps\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use DWS_QRWC_Deps\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
