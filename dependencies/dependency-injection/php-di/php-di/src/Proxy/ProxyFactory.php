...
namespace DWS_QRWC_Deps\DI\Proxy;

use DWS_QRWC_Deps\ProxyManager\Configuration;
use DWS_QRWC_Deps\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use DWS_QRWC_Deps\ProxyManager\FileLocator\FileLocator;
use DWS_QRWC_Deps\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use DWS_QRWC_Deps\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use DWS_QRWC_Deps\ProxyManager\Proxy\LazyLoadingInterface;
/**
