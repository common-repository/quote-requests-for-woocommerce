<?php
/**
 * Add variable product to quote request list button.
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/quote-requests/single-product/add-to-list/variable.php.
 *
