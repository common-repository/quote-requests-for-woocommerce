<?php
/**
 * Admin cancelled quote request email
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/quote-requests/emails/admin-cancelled-quote-request.php.
 *
...
<p>
	...
	printf( esc_html__( 'Notification to let you know &mdash; quote request #%1$s belonging to %2$s has been cancelled:', 'quote-requests-for-woocommerce' ), esc_html( $quote->get_quote_number() ), esc_html( $quote->get_formatted_billing_full_name() ) );
	?>
</p>
