 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/quote-requests/emails/admin-new-quote-request.php.
 *
...
<p>
	...
	printf( esc_html__( 'You’ve received the following quote request from %s:', 'quote-requests-for-woocommerce' ), esc_html( $quote->get_formatted_billing_full_name() ) );
	?>
</p>
