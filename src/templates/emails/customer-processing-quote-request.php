<?php
/**
 * Customer processing quote request email
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/quote-requests/emails/customer-processing-quote-request.php.
 *
...
<p>
	...
	printf( esc_html__( 'Just to let you know &mdash; we\'ve received your quote request #%s, and we will let you know once it is processed:', 'quote-requests-for-woocommerce' ), esc_html( $quote->get_quote_number() ) );
	?>
</p>
