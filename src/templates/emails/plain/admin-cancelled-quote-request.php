<?php
/**
 * Admin cancelled quote request email (plain text)
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/quote-requests/emails/plain/admin-cancelled-quote-request.php.
 *
 ...
 * @var     bool                                $plain_text
 * @var     DWS_Email_Cancelled_Quote_Request   $email
 */
...
echo sprintf( esc_html__( 'Notification to let you know &mdash; quote request #%1$s belonging to %2$s has been cancelled:', 'quote-requests-for-woocommerce' ), esc_html( $quote->get_quote_number() ), esc_html( $quote->get_formatted_billing_full_name() ) ) . "\n\n";
