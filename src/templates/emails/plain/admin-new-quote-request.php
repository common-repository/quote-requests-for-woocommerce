 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/quote-requests/emails/plain/admin-new-order.php.
 *
 ...
 * @var     bool                        $plain_text
 * @var     DWS_Email_New_Quote_Request $email
 */
...
echo sprintf( esc_html__( 'You’ve received the following quote request from %s:', 'quote-requests-for-woocommerce' ), esc_html( $quote->get_formatted_billing_full_name() ) ) . "\n\n";
