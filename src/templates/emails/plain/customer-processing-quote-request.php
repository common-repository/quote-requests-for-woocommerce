<?php
/**
 * Customer processing quote request email (plain text)
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/quote-requests/emails/plain/customer-processing-quote-request.php.
 *
 ...
 * @var     bool                                        $plain_text
 * @var     DWS_Email_Customer_Processing_Quote_Request $email
 */
...
echo sprintf( esc_html__( 'Just to let you know &mdash; we\'ve received your quote request #%s, and we will let you know once it is processed:', 'quote-requests-for-woocommerce' ), esc_html( $quote->get_quote_number() ) ) . "\n\n";
